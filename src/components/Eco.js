...
const Eco = () => {
    return (
        <div className='bg-bluegray-100 min-h-screen flex flex-col justify-center items-center'>
            <div className='max-w-screen-xl h-full mx-auto p-6 flex flex-col items-center'>
                ...
                <div className="text-xl text-justify mb-6 text-black">
